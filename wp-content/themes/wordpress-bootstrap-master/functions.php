...
//Excerp com read more
function new_excerpt_more( $more ) {
  return '<a class="btn btn-primary btn-block" href="'. get_permalink( get_the_ID() ) . '"><i class="glyphicon glyphicon-shopping-cart"></i> Saiba mais e peça o seu!</a>';
}
...
function bf_social_share(){ ?>
  <h4>Compartilhe essa oferta:</h4>
  <a class="twitter btn btn-info" href="http://twitter.com/home?status=Black Friday Acens - Aproveite essa promoção: <?php the_permalink(); ?>" title="Compartilhe no Twitter!" target="_blank">Twitter</a>
  <a class="facebook btn btn-primary" href="http://www.facebook.com/sharer.php?u=<?php the_permalink();?>&amp;t=<?php the_title(); ?>" title="Compartilhe no Facebook!" onclick="window.open(this.href); return false;">Facebook</a>
  <a class="google-plus btn btn-danger" target="_blank" href="https://plus.google.com/share?url=<?php the_permalink(); ?>">Google+</a>
<?php }
